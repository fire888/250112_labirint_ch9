...
export const LEVELS: ILevelConf[] = [
    {
        ...
        fogColor: new THREE.Color().setHex(0x232b27),
        fogFar: 30,
        materialWalls: {
            color: new THREE.Color().setHex(0x000000),
            emissive: new THREE.Color().setHex(0xff0000),
            specular: new THREE.Color().setHex(0x000000),
        },
        materialRoad: {
            color: new THREE.Color().setHex(0xffff00),
            emissive: new THREE.Color().setHex(0xffff00),
        },
        materialGround: {
            color: new THREE.Color().setHex(0x000000),
            emissive: new THREE.Color().setHex(0xff0000),
    ...
    //     positionTeleporter: [0, 0],
    //     percentCompleteEnergy: PERCENT_ENERGY,
    //     fogColor: new THREE.Color().setHex(0x2b2241), 
    //     fogFar: 100,
    //     materialWalls: {
    //         color: new THREE.Color().setHex(0xffff00),
    //         emissive: new THREE.Color().setHex(0xffff00),
    //         specular: new THREE.Color().setHex(0x0000ff),
    //     },
    //     materialRoad: {
    //         color: new THREE.Color().setHex(0xffff00),
    //         emissive: new THREE.Color().setHex(0xffff00),
    ...
    //     positionTeleporter: [0, 0],
    //     percentCompleteEnergy: PERCENT_ENERGY,
    //     colorFog: new THREE.Color().setHex(0x2b2241), 
    // },
]